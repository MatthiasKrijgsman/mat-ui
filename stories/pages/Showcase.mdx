...
<div className={'flex flex-col gap-4'} style={{maxWidth: 400}}>
    ...
    <Input label="With description" placeholder="Enter text..." description="This is a helpful description"/>
...
<div className={'flex flex-col gap-4'} style={{maxWidth: 400}}>
    ...
    <InputPassword label="Without toggle" placeholder="Enter password..." enableShowPasswordToggle={false}/>
</div>
</section>
...
<div className={'flex flex-col gap-4'} style={{maxWidth: 400}}>
    <Panel>
        <div className={'text-gray-900 font-semibold'}>Panel title</div>
        <div className={'text-gray-500 text-sm'}>This is a panel component that can contain any content. It provides a bordered card layout with padding and shadow.</div>
    </Panel>
</div>
</section>
...
<Table
    ...
    columns={[
        ...
        {id: 'role', header: 'Role', renderCell: (row) => <Badge color={row.role === 'Admin' ? 'purple' : 'gray'}>{row.role}</Badge>},
    ]}
    rows={[
        {name: 'Sarah Jennings', email: 'sarah@example.com', role: 'Admin'},
        {name: 'Liam Patel', email: 'liam@example.com', role: 'User'},
        {name: 'Emily Wong', email: 'emily@example.com', role: 'User'},
        {name: 'Noah Thompson', email: 'noah@example.com', role: 'Admin'},
        {name: 'Isabella Martin', email: 'isabella@example.com', role: 'User'},
    ]}
/>
</section>

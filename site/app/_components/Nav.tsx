...
export const Nav = () => {
  return (
    <div
      className={ 'border-b border-stone-200 dark:border-stone-700! h-[70px] sticky top-0 bg-stone-100/50 dark:bg-stone-700/50 backdrop-blur-xl' }>
      <div className={ 'w-page-content flex flex-row w-full h-full items-center justify-between' }>
        <div className={ 'flex flex-row items-center gap-3' }>
          ...
          <div
            className={ 'font-mono text-stone-600 dark:text-stone-300 rounded-full border text-sm border-stone-300 dark:border-stone-600 px-2 py-0.5' }>v0.0.18
          </div>
        </div>
